...
\ctexset{
    chapter={
        format={\centering\heiti\zihao{-3}\mdseries},  % 小三号黑体居中，不加粗
        nameformat={},
        titleformat={},
    ...
    listtablename={表格目录},
    section={
        format={\songti\bfseries\zihao{4}\raggedright},  % 四号宋体加粗，顶格
        beforeskip=0.5\baselineskip,
        afterskip=0.5\baselineskip,
        aftername=\ 
    },
    subsection={
        format={\kaishu\bfseries\zihao{4}\raggedright},  % 四号楷体加粗，顶格
        beforeskip=0.5\baselineskip,
        afterskip=0.5\baselineskip,
        aftername=\ 
    }
...
% % {\songti\zihao{-4}\setlength{\baselineskip}{20pt}\setlength{\parindent}{2em}\setlength{\parskip}{0pt}
% (正文格式已在 \mainmatter 后全局设置)
...
% {\songti\zihao{-4}\setlength{\baselineskip}{20pt}\setlength{\parindent}{2em}
